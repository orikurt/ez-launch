...
public class ConfigurationActiviyOriginal extends PreferenceActivity {
	...
	private void prepareLoadOption() {
		...
		loadSnapshot.setOnPreferenceChangeListener(new SetCurValue(Titles, Values));
	...
	public class HelpButtonClick implements OnPreferenceClickListener {
